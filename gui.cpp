...
void gui::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    {
        //[UserButtonCode_jogar] -- add your button handler code here..
        //[/UserButtonCode_jogar]
        
        soma = std::to_string(lancarDado(4));
        arrayResultados = std::to_string(lancarDado(0)) + " " + std::to_string(lancarDado(1)) + " " + std::to_string(lancarDado(2)) + " " + std::to_string(lancarDado(3));

        resultSum.setText(soma, dontSendNotification);
        resulArray.setText("", sendNotification);
        
        resulArray.setText(arrayResultados, sendNotification);
